...
public class LevelBase : MonoBehaviour
{
	...
	public string tutorial_text { get; protected set; }
	public int[,] Level_array { get; protected set; }
    public List<Vector2> Marker_list { get; protected set; }
    public List<Vector2> Empty_list { get; protected set; }
    ...
    public List<EnvironmentEffect> Environment_Effect_List { get; protected set; }
